...
formValue.addEventListener('submit', function (event) {
    ...
    } else if (event.submitter.id == 'all-grades-greater-than') {
    ...
    else if (event.submitter.id == 'some-grades-greater-than') {
        let FilterValueNaN = isFilterValueNaN(filterValue);
        if (FilterValueNaN) {
            alert('Numbers Only');
        } else {
    ...
    else if (event.submitter.id == 'array-filter-and-manipulation') {
        let FilterValueNaN = isFilterValueNaN(filterValue);
        if (FilterValueNaN) {
            alert('Numbers Only');
        } else {
